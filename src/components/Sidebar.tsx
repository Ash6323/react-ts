  ...
  return (
    <nav id="sidebar">
      <div>
        ...
        <Dropdown>
          <Dropdown.Toggle variant="success" id="matters-dropdown" className="sidebar-items">Matters</Dropdown.Toggle>
        ...
        <Dropdown>
        <Dropdown.Toggle variant="success" id="invoices-dropdown" className="sidebar-items">Invoices</Dropdown.Toggle>
          <Dropdown.Menu className="sidebar-dropdown-menu ">
        ...
        <Dropdown>
          <Dropdown.Toggle variant="success" id="invoices-dropdown" className="sidebar-items">View Billings</Dropdown.Toggle>
          <Dropdown.Menu className="sidebar-dropdown-menu ">
            <Dropdown.Item className="dropdown-items" 
                          onClick={()=>navigate("Invoices/BillingForAttorney")}>For Attorney</Dropdown.Item>
            <Dropdown.Item className="dropdown-items" 
                          onClick={()=>navigate("Invoices/BillingByAttorneys")}>By Attorneys</Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
      </div>
    </nav>
